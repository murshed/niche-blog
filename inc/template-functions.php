 ...
 * @return array
 */
function niche_blog_body_classes( $classes ) {
...
add_filter( 'body_class', 'niche_blog_body_classes' );

/**
 * Add a pingback url auto-discovery header for single posts, pages, or attachments.
 */
function niche_blog_pingback_header() {
	if ( is_singular() && pings_open() ) {
		printf( '<link rel="pingback" href="%s">', esc_url( get_bloginfo( 'pingback_url' ) ) );
	}
}
add_action( 'wp_head', 'niche_blog_pingback_header' );

/**
 * niche_blog Excerpt Length
 *
 * @since niche_blog 1.0.0
 *
 * @param null
 * @return void
 */

if ( ! function_exists( 'niche_blog_excerpt_length' ) ) :
   ...
   */
  function niche_blog_excerpt_length( $length ) {
...
add_filter( 'excerpt_length', 'niche_blog_excerpt_length', 999 );
